...
export default function App() {
  ...
  function updateQty(id, qty){ setCart(prev => prev.map(it => it.id===id?{...it, qty: Math.max(1, qty)}:it)); }
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 text-slate-100">
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-slate-950/70 border-b border-slate-800">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-tight">Swax-like Shop</span>
          </div>
                ...
                <Card className="bg-slate-950 border-slate-800 overflow-hidden">
                  <div className="relative">
                    ...
                    <div className="absolute top-2 left-2 flex gap-2">
                      {p.tags.map(t=> <Badge key={t} className="bg-blue-600/20 border-blue-500/30">{t}</Badge>)}
                    </div>
                  </div>
      ...
      <footer className="border-t border-slate-800 py-10">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-4 gap-6 text-sm text-slate-300">
          <div>
            <p className="font-bold mb-2">Swax-like Shop</p>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>WhatsApp: +255 711 111 110</li>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>M-PESA: +255 741 001 698 (Tumaini Menga)</li>
        ...
        <p className="text-center text-slate-500 text-xs mt-6">© {new Date().getFullYear()} Swax-like Shop. All rights reserved.</p>
      </footer>
            ...
            <DialogContent className="bg-slate-950 border-slate-800 max-w-3xl">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    {openProduct.tags.map(t=> <Badge key={t}>{t}</Badge>)}
                  </div>
...
function CheckoutForm({ total, onSuccess }){
  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      <p className="text-xs text-slate-500 text-center">Pay to M-PESA +255 741 001 698 (Tumaini Menga) then send receipt.</p>
    </form>
  );
}
